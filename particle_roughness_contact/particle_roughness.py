...
# print(np.mean(roughness ["PTFE 2x1"]))
...
spec = gridspec.GridSpec(ncols=1, nrows=3, wspace=0.6, hspace=0.8)
...
ax1.set_ylabel("Areal average roughness $Sa$ (μm)")

row_titles = ['Rectangular plastic', 'Square plastic', "Spherical plastic"]
for i, title in enumerate(row_titles):
    fig.text(0.5, 0.93 - i * 0.30, title, ha='center', va='center', fontsize=12)

plt.savefig("roughness.svg", format="svg")
